...
%   \begin{minipage}[b]{1.0\linewidth}
%     \centering
%     \centerline{\includegraphics[width=0.7cm]{images/overall_support_by_country}}
%   %  \vspace{1.5cm}
%     \centerline{(a) Support vs Overall by Countries}\medskip
%   \end{minipage}
%   \hfill
%   \begin{minipage}[b]{1.0\linewidth}
%     \centering
%     \centerline{\includegraphics[width=0.7cm]{images/overall_interest_by_country}}
%   %  \vspace{1.5cm}
%     \centerline{(b) Interest vs Overall by Countries }\medskip
%   \end{minipage}
%   %
%   \caption{Visualize Missing Data}
%   \label{fig:sup_int_overall}
%   %
%   \end{figure}
